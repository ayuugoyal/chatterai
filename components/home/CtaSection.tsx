      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-3xl mx-auto">
          <motion.div
            ...
            className="bg-gradient-to-r from-primary/10 to-accent/10 backdrop-blur-sm rounded-2xl p-6 sm:p-8 md:p-12 border border-white/10 shadow-xl text-center"
          >
            <h2 className="text-xl sm:text-2xl md:text-4xl font-bold mb-3 sm:mb-4 px-2">
              Ready to Transform Your Customer Experience?
            </h2>
            <p className="text-base sm:text-lg mb-6 sm:mb-8 text-foreground/80">
